              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      'กำไรสุทธิหลังหักค่าใช้จ่ายร้าน, ค่าแรงพนักงาน, และเงินเดือนผู้บริหาร ฿85,000',
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  const Text('กลุ่มที่ 1: ส่วนแบ่งกำไร 50% แรก', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                ],
              ),
              Text(
          ...
          _partnerSubCard(
            ...
            salary: ProfitDistribution.nantapornSalary,
          ...
          _partnerSubCard(
            ...
            salary: ProfitDistribution.thayakornSalary,
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  const SizedBox(width: 10),
                  const Text('กลุ่มที่ 2: ส่วนแบ่งกำไร 50% หลัง', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 13)),
                ],
              ),
              Text(
          ...
          _partnerSubCard(
            ...
            salary: ProfitDistribution.churntawanSalary,
          ...
          _partnerSubCard(
            ...
            salary: ProfitDistribution.kanthongSalary,
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: DataTable(
              ...
              rows: [
                _partnerRow('Nantaporn', 'กลุ่มที่ 1 (50%)', profit.nantapornExpensesPaid, ProfitDistribution.nantapornSalary, profit.nantapornProfitShare, profit.nantapornNetPayout, Colors.purple),
                _partnerRow('Thayakorn', 'กลุ่มที่ 1 (50%)', profit.thayakornExpensesPaid, ProfitDistribution.thayakornSalary, profit.thayakornProfitShare, profit.thayakornNetPayout, Colors.blue),
                _partnerRow('Churntawan', 'กลุ่มที่ 2 (50%)', profit.churntawanExpensesPaid, ProfitDistribution.churntawanSalary, profit.churntawanProfitShare, profit.churntawanNetPayout, Colors.teal),
                _partnerRow('Kanthong', 'กลุ่มที่ 2 (50%)', profit.kanthongExpensesPaid, ProfitDistribution.kanthongSalary, profit.kanthongProfitShare, profit.kanthongNetPayout, Colors.amber.shade800),
              ],
            ),
          ),
        ],
