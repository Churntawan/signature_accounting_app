          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                _pnlRow('5. หัก ค่าตอบแทน/เงินเดือนผู้บริหาร 4 ท่าน (รวม ฿${currency.format(profit.totalExecutiveSalaries)})', profit.totalExecutiveSalaries, isHeader: true, color: Colors.orange.shade800),
                _pnlSubRow('   - Nantaporn (เงินเดือน ฿${currency.format(profit.nantapornSalary)})', profit.nantapornSalary),
                _pnlSubRow('   - Thayakorn (เงินเดือน ฿${currency.format(profit.thayakornSalary)})', profit.thayakornSalary),
                _pnlSubRow('   - Churntawan (เงินเดือน ฿${currency.format(profit.churntawanSalary)})', profit.churntawanSalary),
                _pnlSubRow('   - Kanthong (เงินเดือน ฿${currency.format(profit.kanthongSalary)})', profit.kanthongSalary),
                const Divider(height: 24),
                Container(
                  padding: const EdgeInsets.all(12),
                  decoration: BoxDecoration(
